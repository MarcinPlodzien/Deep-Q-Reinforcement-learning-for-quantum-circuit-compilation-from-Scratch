...
class DQNAgent:
    def __init__(self, actions_space, state_dim, learning_rate, gamma, epsilon):
...
agent = DQNAgent(env.actions_space, env.state_dimension, learning_rate, gamma, epsilon) 
model = DQNNetwork(env.state_dimension, len(env.actions_space))
