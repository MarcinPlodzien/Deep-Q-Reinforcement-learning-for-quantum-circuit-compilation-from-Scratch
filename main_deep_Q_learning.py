...
class DQNAgent:
    ...
    def act(self):     # we make sure that actions are not repeat one after another
        done = True
        while( done ):
    ...
    # def act(self):     # we make sure that two similar gates symbols are not repeat one after another
    #     done = True
    #     while( done ):
    #         action_idx = self.choose_action()
    #         action_gate_symbol, _, _, _ = self.action_space[action_idx]
